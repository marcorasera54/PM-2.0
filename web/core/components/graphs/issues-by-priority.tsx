...
export const IssuesByPriorityGraph: React.FC<Props> = (props) => {
  ...
  return (
    <BarGraph
      ...
      tooltip={(datum) => (
        <div className="flex items-center gap-2 rounded-md border border-custom-border-200 bg-custom-background-80 p-2 text-xs" style={{
          borderColor: PRIORITY_TEXT_COLORS[`${datum.data.priority}`.toLowerCase() as TIssuePriorities],
        }}>
          <span
