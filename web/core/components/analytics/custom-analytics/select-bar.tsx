...
export const CustomAnalyticsSelectBar: React.FC<Props> = observer((props) => {
  ...
  return (
    ...
    >
      {!isProjectLevel && (
        <div>
          <h6 className="text-xs text-custom-text-200 mb-2">Progetto</h6>
          <Controller
            name="project"
            control={control}
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 mb-2">Misura (asse-y)</h6>
        <Controller
          name="y_axis"
          control={control}
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 mb-2">Dimensione (asse-x)</h6>
        <Controller
          name="x_axis"
          control={control}
          render={({ field: { value, onChange } }) => (
      ...
      <div>
        <h6 className="text-xs text-custom-text-200 mb-2">Gruppo</h6>
        <Controller
          name="segment"
          control={control}
          render={({ field: { value, onChange } }) => (
