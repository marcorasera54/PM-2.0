        ...
        {isLoading ? (
          ...
          <>
            <div className="mt-7 border-b-[0.5px] border-custom-border-200 grid grid-cols-12 gap-1 text-xs text-custom-text-300 pb-1">
              ...
              <h6 className="text-center col-span-1">Priorità</h6>
              {["upcoming", "pending"].includes(tab) && <h6 className="text-center col-span-2">Data di scadenza</h6>}
              {tab === "overdue" && <h6 className="text-center col-span-2">Scaduto il</h6>}
              {type === "assigned" && tab !== "completed" && <h6 className="text-center col-span-2">Bloccato da</h6>}
              {type === "created" && <h6 className="text-center col-span-2">Assegnato a</h6>}
            </div>
