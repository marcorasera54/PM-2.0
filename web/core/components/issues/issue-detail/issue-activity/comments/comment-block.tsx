...
export const IssueCommentBlock: FC<TIssueCommentBlock> = observer((props) => {
  ...
  return (
    <div className={`relative flex gap-3 ${ends === "top" ? `pb-2` : ends === "bottom" ? `pt-2` : `py-2`}`}>
      ...
      <div className="flex-shrink-0 relative w-7 h-7 rounded-full flex justify-center items-center z-[3] bg-gray-500 text-white uppercase font-medium">
        ...
        <div className="absolute top-3 left-4 w-5 h-5 rounded-full overflow-hidden flex justify-center items-center bg-custom-background-80">
