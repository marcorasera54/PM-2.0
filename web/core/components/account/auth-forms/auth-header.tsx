...
const Titles = {
  [EAuthModes.SIGN_IN]: {
    ...
    [EAuthSteps.PASSWORD]: {
      header: "Accedi o Registrati",
      subHeader: "Accedi utilizzando la tua password.",
    },
    [EAuthSteps.UNIQUE_CODE]: {
      header: "Accedi o Registrati",
      subHeader: "Accedi utilizzando il tuo codice univoco.",
    },
  },
  [EAuthModes.SIGN_UP]: {
    [EAuthSteps.EMAIL]: {
      header: "Registrati o Accedi",
      subHeader: "",
    },
    [EAuthSteps.PASSWORD]: {
      header: "Registrati o Accedi",
      subHeader: "Registrati utilizzando una password",
    },
    [EAuthSteps.UNIQUE_CODE]: {
      header: "Registrati o Accedi",
      subHeader: "Registrati utilizzando un codice univoco",
    },
  },
};
