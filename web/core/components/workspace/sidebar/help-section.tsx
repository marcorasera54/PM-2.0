    ...
    <>
      ...
      >
        ...
        >
          <CustomMenu
            customButton={
              ...
              >
                <Tooltip tooltipContent="Aiuto" isMobile={isMobile} disabled={isNeedHelpOpen}>
          ...
          >
            {ENABLE_LOCAL_DB_CACHE && (
              <CustomMenu.MenuItem>
                ...
                >
                  <span className="racking-tight">Cache Locali</span>
                  <ToggleSwitch
                    value={canUseLocalDB}
            ...
            <CustomMenu.MenuItem>
              <button
                ...
                className="flex w-full items-center justify-start text-xs hover:bg-custom-background-80"
              >
                <span className="text-xs">Novità</span>
              </button>
            </CustomMenu.MenuItem>
        ...
        */}
        ...
        >
          <Tooltip tooltipContent={`${isCollapsed ? "Espandi" : "Nascondi"}`} isMobile={isMobile}>
            <button
              type="button"
